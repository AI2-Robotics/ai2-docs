...
2. Cut the external hot-melt strap and remove the top cover.
   <Image src={getting_started_2} alt="" width="200"/>

3. Press the plastic fasteners, disassemble and remove the side coaming of the packaging. Open the ramp plate slot and lower the plate.
